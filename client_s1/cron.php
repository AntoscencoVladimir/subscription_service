...
ОБЯЗАТЕЛЬНО!!! Вся база для сервера client_sXXX будет храниться в тип SQLITE. Должно быть создано структура на базе ТЗ (емайлы для отсылки, данные о отсылки для учета переходов, статистика).
